...
export const printCliHelp = () => {
  ...
  console.log('  profile [show]             Show local profile details')
  console.log('  profile set [--fn <name>] [--nick <nickname>] [--photo <path>] [--photo-type <mime>] Update local profile')
  console.log('  profile clear-photo        Remove the local profile photo')
  ...
  console.log('  feed post <message> [--title <title>] [--tag <tag>] [--cover <path>] Publish a post to your feed')
  console.log('  feed article <message> [--title <title>] [--tag <tag>] [--cover <path>] [--cover-target <peer>] Publish an article with a cover image')
